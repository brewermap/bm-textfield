  ...
  <style>
    ...
    */
    ...
    .mdc-text-field {
      ...
      border-radius: var(--bm-border-radius) var(--bm-border-radius) 0 0;
      display: inline-flex;
      position: relative;
      box-sizing: border-box;
      height: 56px;
      ...
      .mdc-text-field .mdc-text-field__input {
        caret-color: #6200ee;
        /* @alternate */
        caret-color: var(--bm-primary-color); 
      }
      .mdc-text-field .mdc-text-field__input::selection {
    ...
    .mdc-text-field--outlined:not(.mdc-text-field--disabled) .mdc-notched-outline__idle {
      border-color: var(--bm-primary-color-tint); 
    }
    .mdc-text-field--outlined:not(.mdc-text-field--disabled) .mdc-notched-outline__path {
      stroke: var(--bm-primary-color-tint); 
    }
